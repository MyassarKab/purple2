       ...
       <table id="datatable" class="table table-striped table-bordered">
         ...
         <tbody>
             ...
             <td>
               ...
               <a href="/Studio-About-Edit/{{$item->id}}"   type="button"  class="btn btn-success"  title="Edit Item"  ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></i></a >
             </td>
       ...
       @endif
          ...
          <!-- <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              ...
              <div class="x_content">
                <br />
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="/Studio-About-Add" method="post" enctype="multipart/form-data">
                      {{ csrf_field() }}
