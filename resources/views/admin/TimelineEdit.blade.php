            ...
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                @if ($errors->any())
                 ...
                 @endif
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="/Timeline-Update/{{$timeline->id}}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                  <!-- Tab panes -->
                  <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="en">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required" value="{{$timeline->title_en}}"  name="title_en" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="ar">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="title_ar" value="{{$timeline->title_ar}}"  required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                    ...
                    <div class="form-group">
                      <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        <a href="/Timeline-All" class="btn btn-primary" type="button">Cancel</a>
