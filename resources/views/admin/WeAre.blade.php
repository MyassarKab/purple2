     ...
     <div class="x_content">
       ...
       <table id="datatable" class="table table-striped table-bordered">
         ...
         <tbody>
              ...
              <tr>
                <td> {{$WeAre->title_en}}</td>
                        <td> {{$WeAre->title_ar}}</td>
                        <td> {!!$WeAre->description_ar!!}</td>
                        <td> {!!$WeAre->description_en!!}</td>
             ...
             <td>
               <a href="/WeAre-Edit/{{$WeAre->id}}"   type="button"  class="btn btn-success"  title="Edit Item"  ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></i></a >
       ...
       @endif
          ...
          <!-- <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              ...
              <div class="x_content">
                <br />
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="/WeAre-Add" method="post" enctype="multipart/form-data">
                      {{ csrf_field() }}
              ...
              <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane active" id="en">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <textarea name="description_en" rows="8" cols="80"></textarea>
                                </div>
                              </div>
                ...
                <div role="tabpanel" class="tab-pane" id="ar">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                      <textarea name="description_ar" rows="8" cols="80"></textarea>
                                    </div>
                                  </div>
               </div>
