...
@endsection
   ...
   <div class="x_panel">
     <div class="x_title">
       <h2>All Timeline  </h2>
       <!-- <h2> <span class="left-margin"> <a href="/Timeline-New" class="btn btn-primary"> Add New Timeline </a> </span> </h2> -->
     ...
     <div class="x_content">
       ...
       <table id="datatable" class="table table-striped table-bordered">
         ...
         <tbody>
             ...
             <td>
               <a href="/Timeline-Delete/{{$item->id}}" class="btn btn-danger" title="Delete Item" ><i class="fa fa-trash" aria-hidden="true"></i></a>
               <a href="/Timeline-Edit/{{$item->id}}"   class="btn btn-success"  title="Edit Item"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></i></a >
       ...
       <div class="x_panel">
         ...
         <div class="x_content">
           ...
           @if ($errors->any())
            ...
            @endif
           <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="/Timeline-Add" method="post" enctype="multipart/form-data">
               {{ csrf_field() }}
             <!-- Tab panes -->
