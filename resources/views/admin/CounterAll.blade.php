       ...
       <table id="datatable" class="table table-striped table-bordered">
         ...
         <tbody>
             ...
             @foreach($Counter as $item)
              <tr>
             <td> <img src="{{asset($item->image)}}" alt="" width="150" height="150"> </td>
             <td> {{$item->name_en}}</td>
             <td> {{$item->name_ar}}</td>
             <td> {{$item->number}}</td>
             <td>
               <a href="/Counter-Delete/{{$item->id}}" class="btn btn-danger" title="Delete Item" ><i class="fa fa-trash" aria-hidden="true"></i></a>
                  ...
                  <div class="modal-body" >
                    <!--  -->
                        ...
                        <!-- <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="/Counter-Update/{{$item->id}}" method="post" enctype="multipart/form-data">
                                  {{ csrf_field() }}
                                <div class="row">
                              ...
                              <div class="col-md-12 col-sm-12 col-xs-12">
                              <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Number<span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="text" id="last-name" name="number" required="required" class="form-control col-md-7 col-xs-12" value="{{$item->number}}">
                                </div>
                              </div>
                              </div>
                              <div class="col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                @endif
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="/Counter-Add" method="post" enctype="multipart/form-data">
                      {{ csrf_field() }}
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Name EN<span class="required">*</span>
                    </label>
