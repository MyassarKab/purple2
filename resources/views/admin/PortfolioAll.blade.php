...
@endsection
   ...
   <div class="x_panel">
     <div class="x_title">
       <h2>All Portfolio Development </h2>
     ...
     <div class="x_content">
       ...
       <table id="datatable" class="table table-striped table-bordered">
         ...
         <tbody>
             ...
             <td> {{$item->name_ar}}</td>
             <td>
               <a href="/Portfolio-Delete/{{$item->id}}" class="btn btn-danger" title="Delete Item" ><i class="fa fa-trash" aria-hidden="true"></i></a>
                  ...
                  <div class="modal-body" >
                    <!--  -->
                        ...
                        <!-- <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="/Portfolio-Update/{{$item->id}}" method="post" enctype="multipart/form-data">
                                  {{ csrf_field() }}
                                <div class="row">
       ...
       @endif
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                <br />
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="/Portfolio-Add" method="post" enctype="multipart/form-data">
                      {{ csrf_field() }}
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Name EN<span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" id="first-name" required="required" name="name_en" value="{{ old('name_en') }}" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Name AR<span class="required">*</span>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" id="last-name" name="name_ar" value="{{ old('name_ar') }}" required="required" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
