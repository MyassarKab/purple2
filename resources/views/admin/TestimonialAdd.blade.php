          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                @endif
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="/Testimonial-Add" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                  <!-- Tab panes -->
                  <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="en">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required"  name="position_en" class="form-control col-md-7 col-xs-12">
                    ...
                    <div role="tabpanel" class="tab-pane" id="ar">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <input type="text" id="first-name" required="required"  name="position_ar" class="form-control col-md-7 col-xs-12">
