                      ...
                      <div class="x_panel">
                        ...
                        <div class="x_content">
                          ...
                          <div class="row">
                            ...
                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="/Client-Update/{{$client->id}}" method="post" enctype="multipart/form-data">
                                  {{ csrf_field() }}
                                <div class="row">
                             ...
                             <div class="form-group">
                               ...
                               <div class="col-md-6 col-sm-6 col-xs-12">
                                 <input type="text" name="name_en" value="{{$client->name_en}}" class="form-control  col-md-7 col-xs-12" required >
                                </div>
                             </div>
                            </div>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="name_ar" value="{{$client->name_ar}}" class="form-control  col-md-7 col-xs-12"  >
                               </div>
                            </div>
                           </div>
                              <div class="col-md-12 col-sm-12 col-xs-12">
