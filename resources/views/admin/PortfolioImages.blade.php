                      ...
                      <div class="x_panel">
                        ...
                        <div class="x_content">
                          ...
                          <div class="row">
                            ...
                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="/Portfolio-Images-Add" method="post" enctype="multipart/form-data">
                                  {{ csrf_field() }}
                                <div class="row">
                             ...
                             <div class="form-group">
                               ...
                               <div class="col-md-6 col-sm-6 col-xs-12">
                                 <input type="text" name="title_en" value="{{old('title_en')}}" class="form-control  col-md-7 col-xs-12" required >
                                </div>
                             </div>
                            </div>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="title_ar" value="{{old('title_ar')}}" class="form-control  col-md-7 col-xs-12"  >
                               </div>
                            </div>
                           </div>
                              <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="image view view-first">
                                  ...
                                  <div class="mask">
                                    ...
                                    <div class="tools tools-bottom">
                                      ...
                                      <a href="/Portfolio-Images-Edit/{{$item->id}}"><i class="fa fa-pencil"></i></a>
                                      <a href="/Portfolio-Images-Delete/{{$item->id}}"><i class="fa fa-times"></i></a>
                                    </div>
                                  </div>
                                </div>
                                <div class="caption">
                                  <p>{{$item->portfolio->name_en}}</p>
                                </div>
                              </div>
                            </div>
