     ...
     <div class="x_content">
       ...
       <table id="datatable" class="table table-striped table-bordered">
         ...
         <tbody>
             ...
             @foreach($PortfolioAbout as $item)
              <tr>
             ...
             <td>
               <!-- <a href="/Portfolio-About-Delete/{{$item->id}}" class="btn btn-danger" title="Delete Item" ><i class="fa fa-trash" aria-hidden="true"></i></a> -->
               <a href="/Portfolio-About-Edit/{{$item->id}}"   type="button"  class="btn btn-success"  title="Edit Item"  ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></i></a >
             </td>
       ...
       @endif
          ...
          <!-- <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              ...
              <div class="x_content">
                <br />
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="/Portfolio-About-Add" method="post" enctype="multipart/form-data">
                      {{ csrf_field() }}
              ...
              <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane active" id="en">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <textarea name="description_en" rows="8" cols="80"   class="form-control col-md-7 col-xs-12"></textarea>
                ...
                <div role="tabpanel" class="tab-pane" id="ar">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                      <textarea name="description_ar" rows="8" cols="80"   class="form-control col-md-7 col-xs-12"></textarea>
